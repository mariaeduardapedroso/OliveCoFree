...
class ModeloAntracnose:
    """Modelo de previsao de Antracnose (Ensemble com IVW)."""
    ...
    def _avaliar_janela_deslizante(self, df: pd.DataFrame):
        ...
        Nota: a antracnose tipicamente so tem 2 anos de dados (2024, 2025),
        pelo que cai naturalmente no fallback de janela=1
        (treina 2024 -> testa 2025).
        """
